...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="modal fade-scale" id="programModal" tabindex="-1" role="dialog" aria-labelledby="programLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-raised btn-primary btn-lg iconpicker-component"><i class="fa fa-fw fa-desktop"></i></button>
                                            <button type="button" class="icp icp-dd btn btn-raised btn-primary btn-lg dropdown-toggle" data-selected="fa-desktop" data-toggle="dropdown">
