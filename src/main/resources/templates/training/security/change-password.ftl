            ...
            <form role="form" action="<@spring.url "/security/change-password" />" method="post">
                <div class="box-body">
                    <div class="form-group has-feedback">
                        ...
                        <input type="password" name="oldPassword" value="" class="form-control" required placeholder="請輸入舊密碼" autocomplete="off" />
                    </div>
                    <div class="form-group has-feedback">
                        <label for="password"><strong>新密碼</strong></label>
                        <input type="password" name="password" value="" class="form-control" required placeholder="請輸入新密碼" autocomplete="off" />
                    </div>
                    <div class="form-group has-feedback">
                        <label for="password"><strong>新密碼確認</strong></label>
                        <input type="password" name="passwordConfirm" value="" class="form-control" required placeholder="請輸入新密碼" autocomplete="off" />
                    </div>
                    <div class="form-group has-feedback">
